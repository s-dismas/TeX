...
\startitemize
  \item The projects home-page is at:\\
  http://saint-dismas.com

  \item You can get pdf's (by book) at:\\
  https://github.com/s-dismas/Pdf

  \item You can purchase printed volumes at:\\
...
\startitemize
  ...
  the `\textasciitilde' above the vowel indicates that either an `n' or
  an `m' has been elided. 
...
\noindent All thoughts, suggestions, comments, or complaints will be
appreciated.
